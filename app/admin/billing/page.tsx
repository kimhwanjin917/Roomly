    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-5 mb-10 text-center text-white shadow-lg">
          <p className="text-lg font-semibold">모든 플랜 30일 무료 체험 포함</p>
          <p className="text-indigo-100 text-sm mt-1">신용카드 등록 후 30일간 무료로 사용해보세요. 언제든지 취소 가능합니다.</p>
        </div>
                    ...
                    <li key={feature} className="flex items-start gap-2.5">
                      <svg
                        className={`w-4 h-4 mt-0.5 flex-shrink-0 ${
                          plan.recommended ? 'text-indigo-600' : 'text-gray-400'
                        }`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
        ...
        <p className="text-center text-gray-400 text-xs mt-8">
          결제는 Stripe를 통해 안전하게 처리됩니다. 구독은 언제든지 취소할 수 있습니다.
        </p>
      </div>
    </div>
  )
