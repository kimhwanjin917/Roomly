...
export default function RoomsClient({ hotelId, initialRooms }: { hotelId: string; initialRooms: Room[] }) {
  ...
  return (
    <>
      ...
      <main className="page-enter md:pb-6" style={{ maxWidth: 800, margin: '0 auto', padding: '20px 16px 80px' }}>
