...
type StaffStat = { staffId: string; name: string; completed: number; avgMinutes: number | null }
type IncompleteRoom = { number: string; floor: number; status: string }
...
export default function StatsClient({ hotelId }: { hotelId: string }) {
  ...
  return (
    <>
      ...
      <main className="page-enter md:pb-6" style={{ maxWidth: 800, margin: '0 auto', padding: '20px 16px 80px', display: 'flex', flexDirection: 'column', gap: 12 }}>
